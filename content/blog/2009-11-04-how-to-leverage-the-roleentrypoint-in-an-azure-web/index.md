...
date: 2009-11-04T00:00:00-08:00
draft: false
...
5. Create local threading variables that you will use to run your method.
   ...
   ```
    ...
    ...
   ```
6. Update the Application\_BeginRequest method to invoke your method on a new thread. Be sure and check to see if the thread is already running, otherwise it will get started multiple times.
