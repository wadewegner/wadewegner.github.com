...
date: 2007-03-09T00:00:00-08:00
draft: false
...
5. Password
6. PATH – with a default installation of Oracle, this would be “C:Oracleora92bin” (yours may be slightly different)
7. Service name – this is the ODBC connection you created
8. User name
9. At this point I’d recommend not specifying anything else, and clicking okay. This will save the settings, and allow you to continue forward. Having clicked okay, go ahead and immediately click “Configure” again to return to the properties.
10. Click “Managing Events”. This will call the Oracle Adapter Wizard, and confirm that you have correctly configured everything. If you are unable to browse the Oracle database, then you have made a mistake somewhere along the way. Click OK or Cancel to exit.
