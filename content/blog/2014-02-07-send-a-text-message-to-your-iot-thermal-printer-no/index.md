...
![](https://f.cloud.github.com/assets/746259/2114554/da19da0a-903e-11e3-9977-7cc67eb248da.jpg)

![](https://f.cloud.github.com/assets/746259/2114556/dd0e28ba-903e-11e3-808c-eee837a68be6.jpg)
...
### [Printing text messages on the IoT thermal printer](#printing-text-messages-on-the-iot-thermal-printer)
...
1. You text a message to a phone number. This phone number is owned by Twilio and I’m effectively “renting” it. They receive the message and send it (and some additional metadata) to a web service I have running in Heroku. This is set by specifying the **Messaging Request URL** on your Twilio number. (Note: Please refer to Twilio’s fantastic developer documentation if you have any problems.)
   ...
   ![Twillio Message Request URL](https://f.cloud.github.com/assets/746259/2115239/f2396b48-904b-11e3-855b-a4f7c03497c0.png)
...
1. I created a script called amqp.py that checks for messages in the CloudAMQP queue and, if found, formats and prints the message.
2. Modified /etc/rc.local to automatically run the amqp.py script when the Raspberry Pi is booted.
...
### [Getting the school lunch menu](#getting-the-school-lunch-menu)
