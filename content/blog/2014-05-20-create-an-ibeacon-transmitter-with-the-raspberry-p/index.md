...
date: 2014-05-20T00:00:00-08:00
draft: false
...
## [Setup the Raspberry Pi as an iBeacon Transmitter](#setup-the-raspberry-pi-as-an-ibeacon-transmitter)
...
### [Step 1: Download an Operating System Image](#step-1-download-an-operating-system-image)
...
### [Step 2: Write the Image to the SD Card](#step-2-write-the-image-to-the-sd-card)
...
### [Step 3: Connect to the Raspberry Pi](#step-3-connect-to-the-raspberry-pi)
...
### [Step 4: Initial Device Configuration](#step-4-initial-device-configuration)
...
### [Step 5: Setup WiFi (Optional)](#step-5-setup-wifi-optional)
...
### [Step 6: Install Required Libraries](#step-6-install-required-libraries)
...
### [Step 7: Download, Make, & Install BlueZ Library](#step-7-download-make--install-bluez-library)
...
## [Setup the Raspberry Pi as an iBeacon Transmitter](#setup-the-raspberry-pi-as-an-ibeacon-transmitter-1)
...
## [Detect Your iBeacon Signal](#detect-your-ibeacon-signal)
