...
date: 2009-03-23T00:00:00-08:00
draft: false
...
10. Open up the **Web.config** file and specify a new default document. This will tell Windows Azure to open up our PHP page by default. Under the <system.webServer> element, add a :
...
11. Additionally, we need to setup a handler in the Web.config file. Add the following code to the  element in the web.Config:
