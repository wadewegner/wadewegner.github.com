...
#### [Python and Attachments with the REST API](#python-and-attachments-with-the-rest-api)
...
The code is pretty straightforward. [simple\_salesforce](https://pypi.python.org/pypi/simple-salesforce/) is great when you want to quickly work with the REST API.

#### [Python and Attachments with the SOAP API](#python-and-attachments-with-the-soap-api)
