...
date: 2007-05-28T00:00:00-08:00
draft: false
...
### [Setting Up Your Oracle Database](#setting-up-your-oracle-database)
...
3. Create a new tablespace. The following script creates a tablespace called “ts\_name” at the root of the drive that Oracle is installed on (e.g. C:), has logging turned on, a default size of 32 MBs that automatically extends to 2 GBs.
