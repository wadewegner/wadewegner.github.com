...
> "I used JWT Bearer Flow with my Scratch Orgs and Dev Hub - you won't believe what happened next!"
>
> — Peter Churchill (@britishboyindc) [January 31, 2018](https://twitter.com/britishboyindc/status/958702877475790848?ref_src=twsrc%5Etfw)
...
### [Create the certificate & private key](#create-the-certificate--private-key)
...
### [Create the Connected App](#create-the-connected-app)
...
To make things easier, I like to use my CLI plugin: `sfdx-waw-plugin` (feel free to contribute here: <https://github.com/wadewegner/sfdx-waw-plugin>). It includes commands for creating the Connected App (and minimizes the manual steps).
...
### [Log into your Dev Hub with `jwt:grant`](#log-into-your-dev-hub-with-jwtgrant)
...
> Successfully authorized YOUR\_DEVHUB\_LOGIN] with org ID [YOUR\_ORG\_ID].
...
### [Create a new scratch org and login with `jwt:grant`](#create-a-new-scratch-org-and-login-with-jwtgrant)
...
> Successfully authorized YOUR\_SCRATCHORG\_USERNAME] with org ID [YOUR\_SCRATCHORG\_ID].
