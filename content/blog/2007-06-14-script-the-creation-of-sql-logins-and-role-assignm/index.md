...
Take a look the *Grant Web Applications and Window Services Access to the Databases* section of the [Installation Guide](http://go.microsoft.com/fwlink/?LinkID=57268) for Commerce Server 2007, and you’ll see that the number of role assignments is quite extensive.
