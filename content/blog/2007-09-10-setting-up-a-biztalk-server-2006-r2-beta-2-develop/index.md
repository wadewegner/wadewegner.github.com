...
- BTS06R2\_Beta2.exe
- BTS06R2\_Beta2\_Accelerators.zip
- BizTalk LOB Adapters Sp1 Beta2.exe
- CustomSOAPHeaderPipeline.zip

Note: if you only want the R2 functionality (e.g. WCF, etc) you only need BTS06R2\_Beta2.exe.
After I downloaded all the files, I first extracted the contents of BTS06R2\_Beta2.exe to a temporary folder (choose a folder you can remember, like C:TempBTS06R2\_Beta2).  Next, I ran Setup.exe from that folder.  Click Next until you get to the Component Installation screen.  You’ll see that there are a few differences from the standard BizTalk components.  Here’s a peak:
