...
- **[WindowsAzure.Storage.Proxy](http://www.nuget.org/packages/WindowsAzure.Storage.Proxy)**: This package contains a class library with the Windows Azure Storage Proxy Cloud Services, and a *WebActivator* enabled class with the default configuration.
