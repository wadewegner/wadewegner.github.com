...
To begin, I was able to get eConnect for GP (en\_econnect\_for\_gp.zip) through my MSDN subscription. If you have Great Plains 9.0, then you should be able to get your hands on this package. When you unzip the package, you’ll notice two files:
...
- Microsoft\_Business\_Solutions\_eConnect.msi - This is the actual installation file. Note: it contains MUCH more than just the BizTalk Server adapters.
