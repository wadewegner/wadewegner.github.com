...
The following [Google search](http://www.google.com/search?hl=en&rls=com.microsoft%3Aen-us%3AIE-SearchBox&rlz=1I7GGIG&q=biztalk+Exception+of+type+%27System.EnterpriseServices.TransactionProxyException%27+was+thrown.) suggested to me that the underlying problem was with MSDTC (*aren’t all BizTalk problems?*). I checked, and double-checked, the MSDTC properties on both servers and couldn’t find anything wrong with the configuration. So, I had to pull out the big guns.
...
3. Go to the registry and delete the MSDTC keys in HKLM/Software/Microsoft/Software/MSDTC, HKLM/System/CurrentControlSet/Services/MSDTC, and HKEY\_CLASSES\_ROOTCID (if they’re still there).
4. Reboot
